...
describe('computeConfidenceLevel', () => {
  ...
  it('does not count documents with erro_leitura as read evidence', () => {
    expect(computeConfidenceLevel([doc('dre', { readingStatus: 'erro_leitura' })])).toBe('baixa');
  });
