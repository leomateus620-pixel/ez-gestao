...
describe('dbg', () => {
  it('shows', () => {
    ...
    console.log('annualPayrollFromDre=', r.values.annualPayrollFromDre);
    console.log('serviceCosts=', r.values.serviceCosts);
    console.log('payrollPercentFromDre=', r.values.payrollPercentFromDre);
  });
});
