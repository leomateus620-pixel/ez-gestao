import { AlertTriangle, Bell, Bot, Building2, Cog, FolderSync, LayoutDashboard, Plug, Search, Send, FileText, MessageCircle, Percent, ScanLine, ShieldCheck } from 'lucide-react';
...
export const menuRegistry: MenuItemConfig[] = [
  ...
  { id: 'envios', label: 'Envios', shortDescription: 'Histórico e status de entregas', route: '/envios', icon: Send, group: 'principal', priority: 'medium', contextRelevance: ['envios'], a11yLabel: 'Abrir envios' },
  { id: 'certidoes', label: 'Certidões', shortDescription: 'Checklist de CNDs por empresa', route: '/certidoes', icon: ShieldCheck, group: 'principal', priority: 'medium', contextRelevance: ['certidoes'], a11yLabel: 'Abrir certidões' },
  { id: 'automacao', label: 'Automação', shortDescription: 'Execuções, exceções e conectores', route: '/automacao', icon: Bot, group: 'principal', priority: 'medium', contextRelevance: ['automacao', 'execucoes', 'excecoes'], badgeKey: 'legacyExceptions', a11yLabel: 'Abrir automação' },
  ...
  { id: 'legacy-consulta', label: 'Consulta CND (legado)', shortDescription: 'Módulos antigos e diagnóstico', route: '/consulta', icon: Search, group: 'legacy', priority: 'low', contextRelevance: ['consulta'], a11yLabel: 'Abrir consulta CND legado' },
];
