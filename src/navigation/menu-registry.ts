...
export const menuRegistry: MenuItemConfig[] = [
  ...
  { id: 'guias-excecoes', label: 'Excecoes', shortDescription: 'Itens que exigem revisao', route: '/guias/excecoes', icon: AlertTriangle, group: 'guias', parent: 'guias', priority: 'high', contextRelevance: ['guias/excecoes'], badgeKey: 'guideExceptions', a11yLabel: 'Abrir excecoes de guias' },
  ...
  { id: 'fator-r', label: 'Fator R', shortDescription: 'Monitoramento PGDAS e alertas', route: '/fator-r', icon: Percent, group: 'principal', priority: 'high', contextRelevance: ['fator-r'], a11yLabel: 'Abrir modulo Fator R' },
  { id: 'classifica', label: 'Classifica', shortDescription: 'Classificacao inteligente de notas', route: '/classifica', icon: ScanLine, group: 'principal', priority: 'high', contextRelevance: ['classifica'], quickActions: [{ id: 'classifica-dashboard', label: 'Dashboard Classifica', route: '/classifica' }, { id: 'classifica-sync', label: 'Importar/sincronizar notas', route: '/classifica', intent: 'primary' }, { id: 'classifica-review', label: 'Fila de revisao', route: '/classifica' }, { id: 'classifica-rules', label: 'Regras do robo', route: '/classifica' }, { id: 'classifica-logs', label: 'Logs', route: '/classifica' }], a11yLabel: 'Abrir modulo Classifica' },
  ...
  { id: 'whatsapp', label: 'WhatsApp', shortDescription: 'Mensageria e status de envios', route: '/whatsapp', icon: MessageCircle, group: 'principal', priority: 'medium', contextRelevance: ['whatsapp'], a11yLabel: 'Abrir modulo WhatsApp' },
...
export const topbarHubs = [
  ...
  { id: 'profile', label: 'Perfil', shortDescription: 'Conta e sessao' },
] as const;
