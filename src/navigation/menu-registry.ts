...
export const menuRegistry: MenuItemConfig[] = [
  ...
  { id: 'integracoes', label: 'Integrações', shortDescription: 'Conectores e status', route: '/integracoes', icon: Plug, group: 'principal', children: ['integracoes-whatsapp'], priority: 'high', contextRelevance: ['integracoes'], quickActions: [{ id: 'manage-connectors', label: 'Gerenciar conexões', route: '/integracoes', intent: 'primary' }], a11yLabel: 'Abrir integrações' },
  { id: 'integracoes-whatsapp', label: 'WhatsApp', shortDescription: 'Mensageria e status de envios', route: '/whatsapp', icon: MessageCircle, group: 'guias', parent: 'integracoes', priority: 'medium', contextRelevance: ['whatsapp','integracoes'], a11yLabel: 'Abrir módulo WhatsApp' },
