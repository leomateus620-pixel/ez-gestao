  ...
  useEffect(() => {
    ...
    fetchTaxReformStore()
      ...
      .catch((error) => {
        ...
        setSyncStatus('local');
        setSyncMessage('Modo local ativo. Alterações ficam em cache até o Supabase estar disponível.');
      })
      .finally(() => {
    ...
    const handle = window.setTimeout(() => {
      ...
      saveTaxReformStore(withDerivedScores(store))
        ...
        .catch((error) => {
          ...
          setRemotePersistenceEnabled(false);
          setSyncStatus('error');
          setSyncMessage('Falha ao salvar no Supabase. O cache local foi preservado.');
        });
    }, 700);
