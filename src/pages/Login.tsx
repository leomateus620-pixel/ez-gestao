    ...
    <main className="liquid-stage flex min-h-screen items-center justify-center p-5">
      <section className="glass-card-elevated relative w-full max-w-md p-7 md:p-9" aria-label="Autenticacao">
        ...
        <div className="relative">
          ...
          <p className="mt-2 text-sm text-foreground/72">Entre para processar documentos e monitorar entregas.</p>

          <form className="mt-7 space-y-4" onSubmit={handleSubmit}>
            <div className="space-y-2">
              <Label htmlFor="email">E-mail</Label>
              <div className="relative">
                <Mail className="absolute left-3 top-3 h-4 w-4 text-foreground/72" />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <LockKeyhole className="absolute left-3 top-3 h-4 w-4 text-foreground/72" />
          ...
          <div className="mt-7 flex items-start gap-2 rounded-xl bg-success/8 p-3 text-xs text-foreground/72">
